...
namespace FinalApp.Controllers
{
    ...
    public class SecurityController : ControllerBase
    {
        ...
        private Token GenerateToken(Account acc)
        {
            ...
            SqlCommand cmd = new SqlCommand(AddRefreshTokenSql, con);
            con.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            con.Close();
        ...
        [HttpPost("RenewToken")]
        public IActionResult RenewToken(Token model)
        {
            var jwtTokenHandler = new JwtSecurityTokenHandler();
            var secretKeyBytes = Encoding.UTF8.GetBytes("ppFAsv+D_`rgab!ge-='*{vx?P4>]qY2");
            ...
            try
            {
                ...
                if (dt != null)
                {
                    ...
                    con.Open();
                    addRefreshToken.ExecuteNonQuery();
                    ...
                    con.Open();
                    getUserAccount.ExecuteNonQuery();
